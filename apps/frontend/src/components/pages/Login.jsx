    ...
    <div className="auth-split-container frontend-auth-container">
      <div className="auth-graphic-side">
        <div className="graphic-content">
          ...
          <h2 className="graphic-title">Empower Your Financial Future</h2>
          <p className="graphic-subtitle">
            TradeVerse provides institutional-grade trading tools, real-time analytics, and spot/futures leverage trading. Sign in to access your dashboard.
          </p>
